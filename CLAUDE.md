...
- **Um banco = uma obra.** `rdos.data`, `cronograma_itens.wbs_id` e `relatorio_semanal_config` (id 1) são únicos no banco inteiro. Nome da obra e início vêm de `src/marca.js`.
